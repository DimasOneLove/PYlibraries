...
# ax.view_init(60, 45) # угол просмотра
...
# ax.plot_trisurf(x, y, z, cmap="viridis")  # Триангуляция - создалась поверхность, соединив точки триугольниками




## Seaborn (работает с DataFrame)
# - DataFrame (Matplotlib - Numpy)
